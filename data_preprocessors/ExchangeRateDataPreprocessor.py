...
class ExchangeRateDataPreprocessor(AbstractDataPreprocessor):
    """
    Data Preprocessor for ExchangeRate dataset.
    """
    ...
    def preprocess(self):
        ...
        feature_list = [data]
        if self.add_feature_time_of_day: #note this dataset is daily data
...
if __name__ == '__main__':
    data_path = 'data/regression_dataset/ExchangeRate/ExchangeRate.csv'
    data_preprocessor = ExchangeRateDataPreprocessor(data_path)
