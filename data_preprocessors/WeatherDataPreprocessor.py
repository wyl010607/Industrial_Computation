...
class WeatherDataPreprocessor(AbstractDataPreprocessor):
    """
    Data Preprocessor for Weather dataset.
    """
    ...
    def __init__(
        ...
        data_path,
        adj_mx_path=None,
        steps_per_day=144,  # interval is 1 hour
        ...
        **kwargs,
        ...
        steps_per_day : int, optional
            Number of steps per day. Default is 144.
