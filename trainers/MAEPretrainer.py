...
class MAEPretrainer(AbstractTrainer):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.forward_features = forward_features if forward_features is not None else [0]
    ...
    def train_one_epoch(self, data_loader):
        ...
        for _, _, pretrain_history_data in tqmd_:
            ...
            # feed forward
            reconstruction_masked_tokens, label_masked_tokens = self.model(history_data=pretrain_history_data)
            loss = self.loss_func(reconstruction_masked_tokens, label_masked_tokens)
