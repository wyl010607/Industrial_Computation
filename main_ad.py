...
def main(args):
    ...
    train_dataset, train_sampler, train_shuffle, val_dataset, val_sampler, \
    ...
    epoch_results = trainer.train(train_dataloader, test_dataloader, thre_dataloader)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--train_config_path",
        type=str,
        default="./config/train_config/MC_train_config.yaml",
    ...
    parser.add_argument(
        "--data_config_path",
        type=str,
        default="./config/data_config/MC_config.yaml",
    ...
    parser.add_argument(
        "--model_save_path",
        type=str,
        default="./model_states/MCdetector.pkl",
