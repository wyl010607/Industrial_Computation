...
class MultiStepForecastWithPretrainDataset(AbstractDataset):
    """
    A dataset class for multi-step time series forecasting with pretraining.
    Single step forecasting is a special case of multi-step forecasting when set forecast_len=1.
    """

    def __init__(
        self, data, history_len, forecast_len, long_history_len, *args, **kwargs
    ):
        """
