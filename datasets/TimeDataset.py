...
class TimeDataset(AbstractDataset):
    def __init__(self, raw_data, edge_index, slide_win, slide_stride, mode='train', *args, **kwargs):
    ...
    def process(self, data, labels):
        x_arr, y_arr = [], []
        labels_arr = []
        slide_win, slide_stride = self.slide_win, self.slide_stride
