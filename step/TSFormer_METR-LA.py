...
CFG.TRAIN.DATA.BATCH_SIZE = 6 # WCY changed, to save time, later undo
...
# dataloader args, optional
CFG.VAL.DATA.BATCH_SIZE = 6 # WCY changed, to save time, later undo
...
# dataloader args, optional
CFG.TEST.DATA.BATCH_SIZE = 6 # WCY changed, to save time, later undo
